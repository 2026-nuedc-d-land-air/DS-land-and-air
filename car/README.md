...
<details open>
<summary><strong>阅读导航</strong>（可折叠）</summary>

**当前实现**

- [系统实物与场地](#system-visuals)
- [当前比赛固件说明](#current-firmware)
- [器件材料与功能特性](#bill-of-materials) · [功能特性](#features)
- [工程结构与任务流程](#project-structure) · [任务执行拆解](#mission-flow)
- [比赛实现要点与实际引脚](#competition-points) · [当前使用引脚](#active-pins)
- [ZET6 资源总台账](#pin-ledger)

**复盘与学习**

- [学习经验与设计笔记（历史内容，可展开）](#learning-notes)
- [团队协作体会](#team-reflection)

</details>

<a id="system-visuals"></a>
## 系统实物与场地
...
<details>
<summary><strong>展开学习经验与设计笔记</strong>（理论、原理图、PCB、装车和代码复盘）</summary>
...
<a id="team-reflection"></a>
## 团队协作体会

团队是一种很重要的经历甚至是资源，加入团队可以学习到很多有用的知识。这些知识是很难通过ai学习能发散出来的。我在这些经历里面学习到了电池的使用和测量，还有相应工具的使用。团队经历里面明白了沟通的重要，在团队里面分工合作，这些是ai辅助没办法一起学到的。
想做什么就一直做，水到一定能渠成。我之前做了很多东西，真的有效帮助了当前的我。
