...
int32_t g_height_velocity_limit = 20;
...
void pid_set_height_velocity_limit(int32_t limit)
{
    g_height_velocity_limit = clamp_limit(limit);
}
...
int32_t pid_get_height_velocity_limit(void)
{
    return g_height_velocity_limit;
}
...
static int32_t calc_hight_vel(int32_t target_hight, int32_t now_hight)
{
    ...
    return Limit_max_int(cal_vel_hight, g_height_velocity_limit);
}
